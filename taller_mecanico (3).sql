...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-10-2021 a las 22:49:24
...
(1, 8011974, 'Toyota', 'Corolla', 2002),
(2, 8011974, 'Honda', 'CÃ­vic', 2006),
(3, 1011987, 'Hiunday', 'Accent', 2008),
(4, 8011976, 'Toyota', 'Rav4', 2014),
(5, 8011976, 'Mazda', '323', 2010),
(6, 10003, 'Toyota', 'Corolla', 2010),
...
CREATE TABLE IF NOT EXISTS `propietarios` (
  ...
  `Nombre_Propietario` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tecnicos` (
  ...
  `Nombre_Tecnico` varchar(100) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tipo_revision` (
  `IdTipo_Revision` int(11) NOT NULL AUTO_INCREMENT,
  `Tipo_Revision` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
