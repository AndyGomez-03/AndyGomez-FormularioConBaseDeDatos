...
<head>
        ...
        <title>Taller Mec&aacute;nico</title>
...
<a href="index.php" class = "navbar-brand">Taller Mec&aacute;nico</a>
    <ul class = "nav-menu">
        ...
        <li>
            <a href="autos.php">Autom&oacute;viles</a>
        </li>
        <li>
            <a href="tipoRevision.php">Tipos de Revisi&oacute;n</a>
        </li>
        <li>
            <a href="tecnico.php">T&eacute;cnicos</a>
        </li>
    </ul>
</div>
</nav>